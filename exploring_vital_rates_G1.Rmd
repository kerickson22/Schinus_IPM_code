...
```{r g1_11}
g1_11 <-manova(cbind(seedlings$Diameter_tplus1, seedlings$Height_tplus1) ~ seedlings$Diameter_t+seedlings$Height_t + seedlings$Site)
summary(g1_11)
sd_x<-summary(lm(seedlings$Diameter_tplus1 ~ seedlings$Diameter_t + seedlings$Height_t + seedlings$Site))$sigma
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Big Cypress"], seedlings$Height_t[seedlings$Site == "Big Cypress"], seedlings$Diameter_tplus1[seedlings$Site == "Big Cypress"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Big Cypress"], seedlings$Height_t[seedlings$Site == "Big Cypress"], seedlings$Height_tplus1[seedlings$Site =="Big Cypress"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Cape Canaveral"], seedlings$Height_t[seedlings$Site == "Cape Canaveral"], seedlings$Diameter_tplus1[seedlings$Site == "Cape Canaveral"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Chekika"], seedlings$Height_t[seedlings$Site == "Chekika"], seedlings$Diameter_tplus1[seedlings$Site == "Chekika"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Chekika"], seedlings$Height_t[seedlings$Site == "Chekika"], seedlings$Height_tplus1[seedlings$Site =="Chekika"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Fort Pierce"], seedlings$Height_t[seedlings$Site == "Fort Pierce"], seedlings$Diameter_tplus1[seedlings$Site == "Fort Pierce"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Fort Pierce"], seedlings$Height_t[seedlings$Site == "Fort Pierce"], seedlings$Height_tplus1[seedlings$Site =="Fort Pierce"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Punta Gorda"], seedlings$Height_t[seedlings$Site == "Punta Gorda"], seedlings$Diameter_tplus1[seedlings$Site == "Punta Gorda"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Punta Gorda"], seedlings$Height_t[seedlings$Site == "Punta Gorda"], seedlings$Height_tplus1[seedlings$Site =="Punta Gorda"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Wild Turkey"], seedlings$Height_t[seedlings$Site == "Wild Turkey"], seedlings$Diameter_tplus1[seedlings$Site == "Wild Turkey"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
# from 3D to 2D coordinates
mypoints <- trans3d(seedlings$Diameter_t[seedlings$Site == "Wild Turkey"], seedlings$Height_t[seedlings$Site == "Wild Turkey"], seedlings$Height_tplus1[seedlings$Site =="Wild Turkey"], pmat=pmat)
# plot in 2D space with pointsize related to distance
points(mypoints, col=4)
...
points(seedlings$Diameter_t[seedlings$Site == "Big Cypress"], seedlings$Height_t[seedlings$Site == "Big Cypress"], cex=seedlings$Diameter_tplus1[seedlings$Site == "Big Cypress"]*coeff_bigger,  pch=1)
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(0.5,1, 1.5, 2,2.5, 3, 3.5,4), c("0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4"), xpd=T, horiz = T, title="Diameter at t +1 (mm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Big Cypress"], seedlings$Height_t[seedlings$Site == "Big Cypress"], cex=seedlings$Height_tplus1[seedlings$Site == "Big Cypress"]*coeff_bigger,  pch=1, bg = "white")
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(3,8, 13,18, 23, 28, 33, 38, 44)*coeff_bigger,c("3", "8", "13", "23", "28", "33", "38", "44"), xpd=T, horiz = T, title="Height at t +1 (cm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Cape Canaveral"], seedlings$Height_t[seedlings$Site == "Cape Canaveral"], cex=seedlings$Diameter_tplus1[seedlings$Site == "Cape Canaveral"]*coeff_bigger,  pch=1)
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(0.5,1, 1.5, 2,2.5, 3, 3.5,4), c("0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4"), xpd=T, horiz = T, title="Diameter at t +1 (mm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Cape Canaveral"], seedlings$Height_t[seedlings$Site == "Cape Canaveral"], cex=seedlings$Height_tplus1[seedlings$Site == "Cape Canaveral"]*coeff_bigger,  pch=1, bg = "white")
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(3,8, 13,18, 23, 28, 33, 38, 44)*coeff_bigger,c("3", "8", "13", "23", "28", "33", "38", "44"), xpd=T, horiz = T, title="Height at t +1 (cm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Chekika"], seedlings$Height_t[seedlings$Site == "Chekika"], cex=seedlings$Diameter_tplus1[seedlings$Site == "Chekika"]*coeff_bigger,  pch=1)
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(0.5,1, 1.5, 2,2.5, 3, 3.5,4), c("0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4"), xpd=T, horiz = T, title="Diameter at t +1 (mm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Chekika"], seedlings$Height_t[seedlings$Site == "Chekika"], cex=seedlings$Height_tplus1[seedlings$Site == "Chekika"]*coeff_bigger,  pch=1, bg = "white")
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(3,8, 13,18, 23, 28, 33, 38, 44)*coeff_bigger,c("3", "8", "13", "23", "28", "33", "38", "44"), xpd=T, horiz = T, title="Height at t +1 (cm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Fort Pierce"], seedlings$Height_t[seedlings$Site == "Fort Pierce"], cex=seedlings$Diameter_tplus1[seedlings$Site == "Fort Pierce"]*coeff_bigger,  pch=1)
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(0.5,1, 1.5, 2,2.5, 3, 3.5,4), c("0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4"), xpd=T, horiz = T, title="Diameter at t +1 (mm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Fort Pierce"], seedlings$Height_t[seedlings$Site == "Fort Pierce"], cex=seedlings$Height_tplus1[seedlings$Site == "Fort Pierce"]*coeff_bigger,  pch=1, bg = "white")
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(3,8, 13,18, 23, 28, 33, 38, 44)*coeff_bigger,c("3", "8", "13", "23", "28", "33", "38", "44"), xpd=T, horiz = T, title="Height at t +1 (cm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Punta Gorda"], seedlings$Height_t[seedlings$Site == "Punta Gorda"], cex=seedlings$Diameter_tplus1[seedlings$Site == "Punta Gorda"]*coeff_bigger,  pch=1)
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(0.5,1, 1.5, 2,2.5, 3, 3.5,4), c("0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4"), xpd=T, horiz = T, title="Diameter at t +1 (mm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Punta Gorda"], seedlings$Height_t[seedlings$Site == "Punta Gorda"], cex=seedlings$Height_tplus1[seedlings$Site == "Punta Gorda"]*coeff_bigger,  pch=1, bg = "white")
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(3,8, 13,18, 23, 28, 33, 38, 44)*coeff_bigger,c("3", "8", "13", "23", "28", "33", "38", "44"), xpd=T, horiz = T, title="Height at t +1 (cm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Wild Turkey"], seedlings$Height_t[seedlings$Site == "Wild Turkey"], cex=seedlings$Diameter_tplus1[seedlings$Site == "Wild Turkey"]*coeff_bigger,  pch=1)
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(0.5,1, 1.5, 2,2.5, 3, 3.5,4), c("0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4"), xpd=T, horiz = T, title="Diameter at t +1 (mm)")
...
points(seedlings$Diameter_t[seedlings$Site == "Wild Turkey"], seedlings$Height_t[seedlings$Site == "Wild Turkey"], cex=seedlings$Height_tplus1[seedlings$Site == "Wild Turkey"]*coeff_bigger,  pch=1, bg = "white")
legend(0, 18.5, pch=1,text.width=0.1, pt.cex = c(3,8, 13,18, 23, 28, 33, 38, 44)*coeff_bigger,c("3", "8", "13", "23", "28", "33", "38", "44"), xpd=T, horiz = T, title="Height at t +1 (cm)")
...
```
#--g1_9c Diameter + Height
#This is still not doing a great job (notice scale). The model is vastly underestimating growth. 
```{r g1_9c}
