...
Load data, set the number of reshufflings to run and initialize a vector to store the values of $\lambda$. 
```{r loading data}
n.samp <- 38 #for now, to test
...
5 runs took 51.15 minutes.
100 runs took 60215.47seconds. 

```{r calculate lambda, eval = F}
...
lam.boot_random <- readRDS("lam.boot_random.rds")
lam.boot_71 <- readRDS("lam.boot_random.rds")
lam.boot <- thing
